...
const FaceMesh = ({ faceLandmarks, emotion, videoRef, isDetecting }) => {
  ...
  useEffect(() => {
    ...
    ctx.shadowBlur = 12;
    draw.drawConnectors(faceLandmarks, FaceLandmarker.FACE_LANDMARKS_LEFT_IRIS, {
      color: irisColor,
      lineWidth: 2.5,
    });
    draw.drawConnectors(faceLandmarks, FaceLandmarker.FACE_LANDMARKS_RIGHT_IRIS, {
      color: irisColor,
      lineWidth: 2.5,
    });
    ctx.shadowBlur = 0;
