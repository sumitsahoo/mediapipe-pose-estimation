 ...
 * Creates an animated floating particle effect with connection lines
 */
const Particles = memo(() => {
	...
	return (
		<div className="fixed inset-0 overflow-hidden pointer-events-none bg-base-100" aria-hidden="true">
			{/* Floating particles */}
			{particles.map((p) => (
				<div
					key={p.id}
